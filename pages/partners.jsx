...
export default function Partners() {
    ...
    return (
      ...
      <img width="400" src="/img/bck4.png" />
            ...
            <a href="https://discord.com/invite/EuUzMvVNPF">
                        <div className="flex-1 gap-x-4 flex items-center bg-gradient-to-b from-neutral-900/80 to-neutral-900/20 p-3 rounded-full">
                            <img className="rounded-full h-32 w-32" src="https://cdn.discordapp.com/emojis/1261461925385080833.webp?size=320" />
                            <div>
                                <h1 className="leading-none text-3xl font-bold text-white">Vertex Development</h1>        
